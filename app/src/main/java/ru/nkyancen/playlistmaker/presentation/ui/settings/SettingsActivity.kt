package ru.nkyancen.playlistmaker.presentation.ui.settings
...
class SettingsActivity : AppCompatActivity() {
    ...
    private val themeManager = Creator.provideNightModeInteractor()
    ...
    override fun onResume() {
        super.onResume()
        themeSwitcher.isChecked = themeManager.getSettingsValue()
    }
}